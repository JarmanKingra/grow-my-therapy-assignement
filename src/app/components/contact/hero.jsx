  ...
  return (
    <section className="grid md:grid-cols-12 bg-[var(--foreground-2)] md:p-20 md:flex-row justify-center items-center">
      <div className="col-span-6 place-items-center md:place-items-start">
        <h1 className=" text-4xl md:text-7xl mt-10 font-semibold  mb-5 md:mb-15">Let’s Connect</h1>
        ...
        <div className="col-span-6 p-8 pl-10 relative flex flex-col items-center">
          <Image
            src="/introPic1.png"
          ...
          <Image
            ...
            width={200}
            height={200}
            className="absolute top-45 left-35 w-25 h-25 md:top-65 md:left-40 md:w-40 md:h-40 rounded-full object-cover"
            priority
          />
        </div>
      </div>
      <div className="col-span-6 p-5">
        <div>
          <p className="bg-[var(--foreground)] text-[var(--background)] text-xl p-4 md:p-10 py-5 text-center md:text-start">
            <b>PLEASE NOTE:</b> If you opt to use a “Form Block” on your contact
